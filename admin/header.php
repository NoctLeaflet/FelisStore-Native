...
<head>
  ...
  <title>Dashboard Admin - Felis Store</title>
...
<body class="hold-transition skin-red-light sidebar-mini">
  <div class="wrapper">
    ...
    <header style="background:#ab8b83;" class="main-header" >
      <a href="index.php" class="logo" style="background:#ab8b83;">
        <span class="logo-mini"><b>FELIS </b>STORE </span>
        <span class="logo-lg"><b>FELIS </b>STORE</span>
      </a>
      <nav class="navbar navbar-static-top" style="background:#ab8b83;">
