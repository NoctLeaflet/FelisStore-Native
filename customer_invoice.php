					...
					<div class="row">
						...
						while($i = mysqli_fetch_array($invoice)){
							...
							<div class="col-lg-12">
								...
								<?php if($i['rating'] == NULL) :?>
								<form method="post" action="rating.php">
									<input type="hidden" name="invoice_id" value="<?= $i['invoice_id'] ?>">
									<div class="row">
										<div class="col-sm-12">
											<span class='label label-success'>Rating Produk :</span>
											<select onchange="this.form.submit()" name="rating"  style="width: 70px">
								...
								<?php else : ?>
									<span class='label label-success'>Rating Produk : <i data-star="<?=$i['rating'] ?>"></i></span> 
								<?php endif ?>
								<br/>
								<br/>
