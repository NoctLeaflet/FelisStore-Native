								...
								<div class="product product-single">
									...
									<div class="product-body">
										...
										<div class="product-rating">
												<?php
													$datas = mysqli_query($koneksi,"SELECT AVG(i.rating) AS rating FROM produk p 
																				INNER JOIN transaksi t ON p.produk_id=t.transaksi_produk 
																				INNER JOIN invoice i ON t.transaksi_invoice=i.invoice_id WHERE p.produk_id={$d['produk_id']}");
													$ds=mysqli_fetch_array($datas);
												?>
											<i data-star="<?=$ds['rating'] ?>"></i>
										</div>
