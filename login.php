...
<body class=" bg-primary" style="background:#ab8b83;">
  <div class="container">
    <div class="login-box">
        ...
        <form action="periksa_login.php" method="POST">
          ...
          <div class="row">
            <div class="col-xs-offset-8 col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat" style="background:#ab8b83;">LOGIN</button>
            </div>
          </div>
        </form>
