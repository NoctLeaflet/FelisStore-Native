			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="frontend/img/logo2.png" alt="">
						</a>
					</div>
					<!-- /footer logo -->
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<ul class="footer-social">
						<li><a style="color:#fff;" href="https://www.facebook.com/shimakaze.chan21/" ><i class="fa fa-facebook"></i></a></li>
						<li><a style="color:#fff;" href="https://twitter.com/Yommu21"><i class="fa fa-twitter"></i></a></li>
						<li><a style="color:#fff;" href="https://www.instagram.com/noctleaflet_/"><i class="fa fa-instagram"></i></a></li>
						<li><a style="color:#fff;" href="https://wa.me/62895411710523"><i class="fa fa-whatsapp"></i></a></li>
					</ul>
					<!-- /footer social -->
				</div>
			</div>
